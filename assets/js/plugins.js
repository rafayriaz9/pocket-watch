...
!(function (e, n, t, o) {
    ...
    e.fn.pagepiling = function (i) {
        ...
        e.extend(e.easing, {
            ...
            (s.setMouseWheelScrolling = function (e) {
                e
                    ? c.get(0).addEventListener
                        ? (c.get(0).addEventListener("mousewheel", k, !1), c.get(0).addEventListener("wheel", k, !1))
                        : c.get(0).attachEvent("onmousewheel", k)
                    : c.get(0).addEventListener
                    ? (c.get(0).removeEventListener("mousewheel", k, !1), c.get(0).removeEventListener("wheel", k, !1))
            ...
            e(c).css({ overflow: "hidden", "-ms-touch-action": "none", "touch-action": "none" }),
        ...
        function S(n, t) {
            ...
            if (!i.activeSection.is(n)) {
                ...
                void 0 === i.animated && (i.animated = !0),
                    void 0 !== i.anchorLink && ((s = i.anchorLink), (c = i.sectionIndex), m.anchors.length ? ((location.hash = s), M(location.hash)) : M(String(c))),
                    ...
                    "down" === i.yMovement
                        ...
                        : ((i.translate3d = "translate3d(0px, 0px, 0px)"), (i.scrolling = "0"), (i.animateSection = n)),
                    ...
                    (function (n) {
                        m.css3
                            ...
                            : ((n.scrollOptions = x(n.scrolling)),
                              n.animated
                                  ? n.animateSection.animate(n.scrollOptions, m.scrollingSpeed, m.easing, function () {
                                        b(n), w(n);
                                    })
        ...
        e(".pp-section")
            ...
            .promise()
            .done(function () {
                m.navigation && (e("#pp-nav").css("margin-top", "-" + e("#pp-nav").height() / 2 + "px"), e("#pp-nav").find("li").eq(e(".pp-section.active").index(".pp-section")).find("a").addClass("active")),
        ...
        function I() {
            return t.PointerEvent ? { down: "pointerdown", move: "pointermove", up: "pointerup" } : { down: "MSPointerDown", move: "MSPointerMove", up: "MSPointerUp" };
        }
        function X(e) {
            var n = new Array();
                ...
                if ((o.length || n.preventDefault(), !y())) {
                    ...
                    (v = i.y),
                        ...
                        "horizontal" === m.direction && Math.abs(d - h) > Math.abs(p - v)
                            ? Math.abs(d - h) > (c.width() / 100) * m.touchSensitivity && (d > h ? L("down", o) : h > d && L("up", o))
                            : Math.abs(p - v) > (c.height() / 100) * m.touchSensitivity && (p > v ? L("down", o) : v > p && L("up", o));
                }
            }
        }
        function q() {
            ...
            e(n).on(
                {
                    mouseenter: function () {
                        ...
                        e('<div class="pp-tooltip ' + m.navigation.position + '">' + n + "</div>")
                            .hide()
                            .appendTo(e(this))
                            .fadeIn(200);
                    },
